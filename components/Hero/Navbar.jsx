  ...
  return (
    <nav
      className={`select-none ${
        scrollY > 10 ? "bg-blue-800" : "bg-white"
    ...
    >
        ...
        >
          ...
          >
            <li onClick={() => setActive(0)}>
              <a
                href="#"
                className={`block py-2 text-lg pl-3 pr-4 md:hover:border-b-4 rounded md:rounded-none dark:hover:bg-gray-900 dark:md:hover:bg-black md:bg-transparent ${
                  active === 0
                    ? scrollY > 10
      ...
      <a
        href="#"
        className={`fixed bottom-0 transition delay-150 duration-300 ease-in-out right-10 ${
          scrollY > 10 ? "-translate-y-5" : "translate-y-40"
        }`}
      >
