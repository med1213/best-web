...
export default function Contact() {
    ...
    return (
        <>
            <section className="relative z-10 overflow-hidden lg:px-0 px-10 dark:bg-black bg-white py-20 lg:py-[120px]" id='contact'>
                                ...
                                <form onSubmit={handleSubmit(onSubmit)}>
                                    ...
                                    <div className="mb-6">
                                        <input
                                            ...
                                            placeholder="ຊື່: ......"
                                            {...register("fullname")}
                                            className="text-body-color border-[f0f0f0] dark:text-black dark:bg-gray-200 focus:border-primary w-full rounded border py-3 px-[14px] text-base outline-none focus-visible:shadow-none" required
                                        />
                                    </div>
                                    <div className="mb-6">
                                        <input
                                    ...
                                    <div>
                                        <button
                                            type="submit"
                                            className="bg-primary border-primary w-full rounded border p-3 text-white transition hover:bg-opacity-90" required
                                        >
                                            Send Message
                                        </button>
                                    </div>
